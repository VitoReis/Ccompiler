...
def analyse():
    ...
    while True:
        ...
        if not charA:                                                               #Caso programa tenha terminado
            ...
            tokenCreated, previousRead, colon = tokenReservedOrId(charA,
                                                                  file,
                                                                  colon,
                                                                  logicOperatorsList,
                                                                  arithmeticOperatorsList,
...
def tokenReservedOrId(charA, file, colon, logicOperatorList, arithmeticOperatorList, literalsList):
    ...
    while charB != ' ' and not charB in logicOperatorList and\
    not charB in arithmeticOperatorList and not charB in literalsList:
        buff += charB
        charB = file.read(1)
